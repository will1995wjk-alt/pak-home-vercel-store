...
export default function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-[#062a18] shadow-lift transition hover:scale-105"
    >
