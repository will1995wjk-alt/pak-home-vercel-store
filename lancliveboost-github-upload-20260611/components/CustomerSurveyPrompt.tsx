  ...
  return (
    <section id="customer-survey" className="bg-paper py-8">
      <div className="container">
        <div className="flex flex-col gap-5 rounded-xl border border-brand/20 bg-white p-6 text-ink shadow-lift md:flex-row md:items-center md:justify-between md:p-8">
          <div>
